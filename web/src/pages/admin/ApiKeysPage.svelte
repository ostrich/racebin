      ...
      <form class="list-filter-bar" onsubmit={applySearch}>
        <label class="field list-filter-search"
          ><span>Search</span><input
            type="search"
            placeholder="Name, owner, prefix, or privilege"
            bind:value={search}
          /></label
        >
        ...
        <label class="field list-filter-select"
          ><span>Sort</span><select
            ...
            ><option value="used">Last used</option></select
          ></label
        >
        <label class="field list-filter-select"
            ...
            <article class="data-row">
              <div>
                ...
                <div class="badge-group">
                  {#each key.scopes as scope}<span class="badge">{scope}</span>{/each}
                </div>
              </div>
              <div class="row-actions">
                <button class="button" onclick={() => toggle(key)}
