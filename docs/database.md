...
live upload leases prevent periodic cleanup from mistaking staged or newly
promoted files for debris. A process crash releases those leases and leaves the
normal grace period to distinguish recoverable debris. Racebin cannot
